...
public class Login_stepDefs {
    ...
    public void the_user_enters_mike_credentials() {
        System.out.println("I enter username and click the login button");

    }

    @Then("The user should be able login")
    public void the_user_should_be_able_login() {
        System.out.println("I verify that url changed on Dashboard page");

    }

    @When("The user enters Sebastian credentials")
    public void theUserEntersSebastianCredentials() {
        System.out.println("I enter Sebastian username and click the login button");
    }
    @When("The user enters Jhon Nash credentials")
    public void theUserEntersJhonNashCredentials() {
        System.out.println("I enter Jhon Nash username and click the login button");

    }

    @When("The user enters Rosa credentials")
    public void the_user_enters_rosa_credentials() {
        System.out.println("I enter Rosa username and click the login button");
    }
